export class DetectionModeTwillight extends foundry.canvas.perception.DetectionMode {
  ...
  _canDetect(visionSource, target) {
    ...
    const isBlind = ((src instanceof TokenDocument) && (this.type === foundry.canvas.perception.DetectionMode.DETECTION_TYPES.SIGHT)
