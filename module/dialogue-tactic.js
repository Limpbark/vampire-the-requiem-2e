export class TacticDialogue extends Application {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "systems/vampire-the-requiem-2e/templates/dialogues/dialogue-tactic.html",
      width: 400,
    });
  }
  ...
  async _onRoll(ev) {
    ...
    await this.item.showChatCard();
    if (!dicePool.noDice) {
      this.actor.roll({ traits: dicePool.attributes, diceBonus: dicePool.value });
